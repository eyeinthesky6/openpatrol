...
setup(
    ...
    description="OpenPatrol ROS 2 ground, mast and MAVLink mobility adapters",
    license="Apache-2.0",
    entry_points={"console_scripts":[
        ...
        "sentinel_mast_bridge = openpatrol_adapter.sentinel_mast_bridge:main",
        "mavlink_velocity_adapter = openpatrol_adapter.mavlink_velocity_adapter:main",
        "mavros_state_guard = openpatrol_adapter.mavros_state_guard:main",
